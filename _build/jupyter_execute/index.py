...
for det in dets:
    ...
    if make_plots:
        ...
        # -- Plot the result
        plot1(time, timemax, SNR, pcolor, det, eventname, plottype)
        plot2(time, tevent, strain_whitenbp, pcolor, det, template_match, timemax, eventname, plottype)
        plot3(template_fft, datafreq, d_eff, freqs, data_psd, pcolor, det, fs, eventname, plottype)
