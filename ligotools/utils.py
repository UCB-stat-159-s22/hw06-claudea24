...
def plot1(time, timemax, SNR, pcolor, det, eventname, plottype):
...
def plot2(time, tevent, strain_whitenbp, pcolor, det, template_match, timemax, eventname, plottype):
	plt.figure(figsize=(10,8))
	plt.subplot(2,1,1)
...
def plot3(template_fft, datafreq, d_eff, freqs, data_psd, pcolor, det, fs, eventname, plottype):
